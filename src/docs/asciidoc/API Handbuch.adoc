...
| `401 Unauthorized`
| Der Client ist nicht authentifiziert und darf nicht auf die Ressource zugreifen.
...
Der Login-Endpunkt empfängt und verarbeitet Nutzername und Passwort. Bei erfolgreichem Login, wird dem Client ein Token
...
anhand derer Studierende ihre Daten einsehen können. Darunter auch solche, die den Fortschritt der StudentIn
anzeigen.
